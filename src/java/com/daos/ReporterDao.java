...
public class ReporterDao {
    public boolean add(Reporter reporter)
    {
        ...
        {
            try{
                String sql="Insert into reporter(name,contact,email,dob,image,address,gender,status,userid,password)values(?,?,?,?,?,?,?,?,?,?)";
            ...
            smt.setString(5,reporter.getImage());
            smt.setString(6, reporter.getAddress());
            smt.setString(7, reporter.getGender());
            smt.setString(8,reporter.getStatus());
            smt.setString(9, reporter.getReporterid());
            smt.setString(10, reporter.getPassword());
